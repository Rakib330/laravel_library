...
<html lang="en">
    <head>
        ...
        <link href="{{asset('/')}}public/backStyle/style.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <input type="checkbox" id="toggler">
        <div class="sidebar">
            <div class="sidebar-header">
                <a href="#" class="logoname">Aitvet Library</a>
            ...
            <div class="sidebar-body">
                <div id="toggle-btn" class="toggle-btn"><label for="toggler"><i class="fas fa-angle-double-left"></i></label></div>
                <div class="admin-profile">
                    <div class="admin-img">
                        <img src="{{session()->get('adminimage')}}" alt="">
                    </div>
                    <h3>{{session()->get('adminname')}}</h3>
                </div>
                <ul>
                    ...
                    <li>
                        <a href="{{URL::to('add-category')}}">
                            <span><i class="fab fa-buromobelexperte"></i></span>
                            <span>Categorys</span>
                        </a>
                    </li>
                    <li>
...
<div class="footer"><p>© 2021 Copyright, Design & Developed By <span style="color:#ff6767;">MD Rakibul Hasan</span></p></div>
        ...
        <script src="{{asset('/')}}public/backStyle/fontawesome.min.js" type="text/javascript"></script>
